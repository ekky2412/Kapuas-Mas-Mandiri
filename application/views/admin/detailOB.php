    ...
    <main>
        <div class="container-fluid">
            ...
            <div class="form-group">
                ...
                <p><?= date('d F Y', strtotime($orderbill['tanggalTiba'])) ?></p>
            </div>
            <div class="form-group">
                <label for="">Tanggal Kapal Sandar : </label>
                <p><?= date('d F Y', strtotime($orderbill['tanggalSandar'])) ?></p>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <p><?= date('d F Y', strtotime($orderbill['tanggalBL'])) ?></p>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <p><?= date('d F Y', strtotime($orderbill['tanggalDiterima'])) ?></p>
            </div>
            <!--  -->
            <div class="form-group">
